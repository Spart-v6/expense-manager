...
const useDynamicColors = () => {
  ...
  const [colors, setColors] = useState(() => {
    if (Platform.Version > 30) return {
      ...
      defaultAccSplitRecCard: PlatformColor("@android:color/system_neutral1_900"),
    ...
    const updateColors = () => {
      const dynamicColors = {
        ...
        defaultHomeRecurrCard: getColor("@android:color/system_accent1_200", "@android:color/system_accent1_800", colorScheme, 
                                        "#039BE5", "#039BE5"),
        defaultAccSplitRecCard: getColor("@android:color/system_accent3_100", "@android:color/system_neutral1_900", colorScheme, 
                                          "#5eb4c0ba", "#5eb4c0ba"),
